...
def mechanicsclick_view2(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
...
def admin_dashboard_view(request):
    ...
    return render(request,'vehicle/ab_dashboard.html',context=dict)


@login_required(login_url='adminlogin')
def admin_customer_view(request):
    return render(request,'vehicle/ab_cd.html')

@login_required(login_url='adminlogin')
def admin_view_customer_view(request):
    customers=models.Customer.objects.all()
    return render(request,'vehicle/ab_view_cd.html',{'customers':customers})
...
def update_customer_view(request,pk):
    ...
    if request.method=='POST':
        ...
        if userForm.is_valid() and customerForm.is_valid():
            ...
            customerForm.save()
            return redirect('admin-view-customer')
    return render(request,'vehicle/update_cd.html',context=mydict)
...
def admin_add_customer_view(request):
    ...
    return render(request,'vehicle/ab_add_cd.html',context=mydict)
...
def admin_view_customer_enquiry_view(request):
    ...
    for enq in enquiry:
        customer=models.Customer.objects.get(id=enq.customer_id)
        customers.append(customer)
    return render(request,'vehicle/ab_view_cd_enquiry.html',{'data':zip(customers,enquiry)})
...
def admin_view_customer_invoice_view(request):
    ...
    for enq in enquiry:
        ...
        customer=models.Customer.objects.get(id=enq['customer_id'])
        customers.append(customer)
    return render(request,'vehicle/ab_view_cd_invoice.html',{'data':zip(customers,enquiry)})

@login_required(login_url='adminlogin')
def admin_mechanic_view(request):
    return render(request,'vehicle/ab_ef.html')


@login_required(login_url='adminlogin')
def admin_approve_mechanic_view(request):
    mechanics=models.Mechanic.objects.all().filter(status=False)
    return render(request,'vehicle/ab_approve_ef.html',{'mechanics':mechanics})
...
def approve_mechanic_view(request,pk):
    ...
    return render(request,'vehicle/ab_approve_ef_details.html',{'mechanicSalary':mechanicSalary})
...
def admin_view_mechanic_view(request):
    ...
    return render(request,'vehicle/ab_view_ef.html',{'mechanics':mechanics})
...
def admin_request_view(request):
    return render(request,'vehicle/ab_request.html')
...
def admin_view_request_view(request):
    ...
    for enq in enquiry:
        customer=models.Customer.objects.get(id=enq.customer_id)
        customers.append(customer)
    return render(request,'vehicle/ab_view_request.html',{'data':zip(customers,enquiry)})
...
def change_status_view(request,pk):
    ...
    return render(request,'vehicle/ab_approve_request_details.html',{'adminenquiry':adminenquiry})
...
def admin_add_request_view(request):
    ...
    if request.method=='POST':
        ...
        if enquiry.is_valid() and adminenquiry.is_valid():
            ...
            print("form is invalid")
        return HttpResponseRedirect('admin-view-request')
    return render(request,'vehicle/ab_add_request.html',context=mydict)

@login_required(login_url='adminlogin')
def admin_approve_request_view(request):
    enquiry=models.Request.objects.all().filter(status='Pending')
    return render(request,'vehicle/ab_approve_request.html',{'enquiry':enquiry})
...
def admin_view_service_cost_view(request):
    ...
    for enq in enquiry:
        ...
        customers.append(customer)
    print(customers)
    return render(request,'vehicle/ab_view_service_cost.html',{'data':zip(customers,enquiry)})
...
def admin_mechanic_attendance_view(request):
    return render(request,'vehicle/ab_ef_attendance.html')
...
def admin_take_attendance_view(request):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            print('form invalid')
    return render(request,'vehicle/ab_take_attendance.html',{'mechanics':mechanics,'aform':aform})
...
def admin_view_attendance_view(request):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            return render(request,'vehicle/ab_view_attendance_page.html',{'mylist':mylist,'date':date})
        else:
            print('form invalid')
    return render(request,'vehicle/ab_view_attendance_ask_date.html',{'form':form})
...
def admin_feedback_view(request):
    ...
    return render(request,'vehicle/ab_feedback.html',{'feedback':feedback})
...
def customer_dashboard_view(request):
    ...
    return render(request,'vehicle/cd_dashboard.html',context=dict)
...
def customer_request_view(request):
    customer=models.Customer.objects.get(user_id=request.user.id)
    return render(request,'vehicle/cd_request.html',{'customer':customer})
...
def customer_view_request_view(request):
    ...
    return render(request,'vehicle/cd_view_request.html',{'customer':customer,'enquiries':enquiries})
...
def customer_view_approved_request_invoice_view(request):
    customer=models.Customer.objects.get(user_id=request.user.id)
    enquiries=models.Request.objects.all().filter(customer_id=customer.id).exclude(status='Pending')
    return render(request,'vehicle/cd_view_approved_request_invoice.html',{'customer':customer,'enquiries':enquiries})
...
def customer_add_request_view(request):
    ...
    return render(request,'vehicle/cd_add_request.html',{'enquiry':enquiry,'customer':customer})
...
def customer_profile_view(request):
    customer=models.Customer.objects.get(user_id=request.user.id)
    return render(request,'vehicle/cd_profile.html',{'customer':customer})
...
def edit_customer_profile_view(request):
    ...
    return render(request,'vehicle/edit_cd_profile.html',context=mydict)
...
def customer_invoice_view(request):
    customer=models.Customer.objects.get(user_id=request.user.id)
    enquiries=models.Request.objects.all().filter(customer_id=customer.id).exclude(status='Pending')
    return render(request,'vehicle/cd_invoice.html',{'customer':customer,'enquiries':enquiries})
...
def customer_feedback_view(request):
    ...
    return render(request,'vehicle/cd_feedback.html',{'feedback':feedback,'customer':customer})
#============================================================================================
